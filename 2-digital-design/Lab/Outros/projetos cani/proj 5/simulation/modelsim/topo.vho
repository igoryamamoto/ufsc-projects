...
SIGNAL \L10|EA.OPERADOR~feeder_combout\ : std_logic;
...
SIGNAL \L10|EA.OU_EXCL~regout\ : std_logic;
...
SIGNAL \L10|EA.OP_NOT~regout\ : std_logic;
SIGNAL \L10|EA~15_combout\ : std_logic;
...
-- Equation(s):
-- \L10|Selector1~0_combout\ = (!\L10|EA.ESCREVE_RES~regout\ & !\L10|EA.OP_NOT~regout\)
...
-- pragma translate_on
PORT MAP (
	datab => \L10|EA.ESCREVE_RES~regout\,
	datad => \L10|EA.OP_NOT~regout\,
...
PORT MAP (
	...
	datain => \L10|EA.OPERADOR~feeder_combout\,
...
\L10|EA.OPERADOR~feeder\ : cycloneii_lcell_comb
-- Equation(s):
-- \L10|EA.OPERADOR~feeder_combout\ = \L10|EA~12_combout\
...
-- pragma translate_on
PORT MAP (
	datad => \L10|EA~12_combout\,
	combout => \L10|EA.OPERADOR~feeder_combout\);
...
-- Equation(s):
-- \L10|Selector4~0_combout\ = (\KEY~combout\(3) & ((\L10|EA.OU~regout\) # ((!\SW~combout\(17) & \L10|Equal0~1_combout\)))) # (!\KEY~combout\(3) & (!\SW~combout\(17) & ((\L10|Equal0~1_combout\))))
...
-- Equation(s):
-- \L10|Selector5~0_combout\ = (\KEY~combout\(3) & ((\L10|EA.OU_EXCL~regout\) # ((\SW~combout\(17) & \L10|Equal0~0_combout\)))) # (!\KEY~combout\(3) & (\SW~combout\(17) & ((\L10|Equal0~0_combout\))))
...
PORT MAP (
	dataa => \KEY~combout\(3),
	datab => \SW~combout\(17),
	datac => \L10|EA.OU_EXCL~regout\,
	datad => \L10|Equal0~0_combout\,
	combout => \L10|Selector5~0_combout\);

-- Location: LCFF_X64_Y3_N23
\L10|EA.OU_EXCL\ : cycloneii_lcell_ff
PORT MAP (
	clk => \CLOCK_50~clkctrl_outclk\,
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \L10|EA.OU_EXCL~regout\);

-- Location: LCCOMB_X64_Y3_N4
\L10|Selector3~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \L10|Selector3~0_combout\ = (\KEY~combout\(3) & ((\L10|EA.SOMA~regout\) # ((!\SW~combout\(17) & \L10|Equal0~0_combout\)))) # (!\KEY~combout\(3) & (!\SW~combout\(17) & ((\L10|Equal0~0_combout\))))
...
-- Equation(s):
-- \L10|Selector8~0_combout\ = (\L10|selecao\(0) & ((\KEY~combout\(3)) # ((!\L10|EA.OU_EXCL~regout\ & !\L10|EA.SOMA~regout\))))
...
-- Equation(s):
-- \L10|Selector8~1_combout\ = (\L10|Selector8~0_combout\) # ((\L10|EA.OU~regout\ & !\KEY~combout\(3)))
...
PORT MAP (
	clk => \CLOCK_50~clkctrl_outclk\,
	datain => \L10|Selector8~1_combout\,
	ena => \KEY~combout\(2),
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \L10|Selector7~0_combout\ = (\L10|selecao\(1) & ((\KEY~combout\(3)) # ((!\L10|EA.SOMA~regout\ & !\L10|EA.OU~regout\))))
...
-- Equation(s):
-- \L10|Selector7~1_combout\ = (\L10|Selector7~0_combout\) # ((!\KEY~combout\(3) & \L10|EA.OU_EXCL~regout\))
...
-- pragma translate_on
PORT MAP (
	datab => \L10|Selector7~0_combout\,
	datac => \KEY~combout\(3),
	datad => \L10|EA.OU_EXCL~regout\,
...
-- Equation(s):
-- \L10|WideOr8~0_combout\ = (\L10|EA.SOMA~regout\) # ((\L10|EA.OU_EXCL~regout\) # (\L10|EA.OU~regout\))
...
-- Equation(s):
-- \L10|Selector0~0_combout\ = (\L10|EA.AGUARDA_SOLTAR_ENTER~regout\ & (((\L10|en_1~regout\)) # (!\KEY~combout\(3)))) # (!\L10|EA.AGUARDA_SOLTAR_ENTER~regout\ & (((\L10|en_1~regout\ & \L10|WideOr8~0_combout\))))
...
-- Equation(s):
-- \L4|m[0]~0_combout\ = (\L10|selecao\(0) & ((\SW~combout\(0) & (!\L10|selecao\(1))) # (!\SW~combout\(0) & ((\L10|selecao\(1)) # (\L0|Q\(0))))))
...
-- Equation(s):
-- \LHEAUHEUHAE|F[0]~0_combout\ = (\L0|Q\(0) & (\SW~combout\(0) $ (VCC))) # (!\L0|Q\(0) & (\SW~combout\(0) & VCC))
-- \LHEAUHEUHAE|F[0]~1\ = CARRY((\L0|Q\(0) & \SW~combout\(0)))
...
-- Equation(s):
-- \L4|m[0]~1_combout\ = (\L4|m[0]~0_combout\) # ((!\L10|selecao\(0) & \LHEAUHEUHAE|F[0]~0_combout\))
...
-- Equation(s):
-- \L10|EA~14_combout\ = (\L10|EA.OPERADOR~regout\) # (((\KEY~combout\(3)) # (\L10|EA.AGUARDA_SOLTAR_ENTER~regout\)) # (!\L10|EA.INICIO~regout\))
...
-- Equation(s):
-- \L10|Selector6~0_combout\ = (\KEY~combout\(3) & (\SW~combout\(17) & ((\L10|Equal0~1_combout\)))) # (!\KEY~combout\(3) & ((\L10|EA.OP_NOT~regout\) # ((\SW~combout\(17) & \L10|Equal0~1_combout\))))
...
PORT MAP (
	dataa => \KEY~combout\(3),
	datab => \SW~combout\(17),
	datac => \L10|EA.OP_NOT~regout\,
	datad => \L10|Equal0~1_combout\,
	combout => \L10|Selector6~0_combout\);

-- Location: LCFF_X64_Y3_N3
\L10|EA.OP_NOT\ : cycloneii_lcell_ff
PORT MAP (
	clk => \CLOCK_50~clkctrl_outclk\,
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \L10|EA.OP_NOT~regout\);

-- Location: LCCOMB_X64_Y3_N0
\L10|EA~15\ : cycloneii_lcell_comb
-- Equation(s):
-- \L10|EA~15_combout\ = (!\L10|EA~14_combout\ & !\L10|EA.OP_NOT~regout\)
...
-- pragma translate_on
PORT MAP (
	datac => \L10|EA~14_combout\,
	datad => \L10|EA.OP_NOT~regout\,
	combout => \L10|EA~15_combout\);

-- Location: LCFF_X64_Y3_N1
\L10|EA.ESCREVE_RES\ : cycloneii_lcell_ff
PORT MAP (
	clk => \CLOCK_50~clkctrl_outclk\,
	datain => \L10|EA~15_combout\,
	aclr => \ALT_INV_KEY[2]~clkctrl_outclk\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \L10|Selector2~0_combout\ = ((!\L10|EA.ESCREVE_RES~regout\ & (\L10|EA.INICIO~regout\ & !\L10|EA.OP_NOT~regout\))) # (!\KEY~combout\(3))
...
PORT MAP (
	clk => \CLOCK_50~clkctrl_outclk\,
	datain => \L10|Selector2~0_combout\,
	aclr => \ALT_INV_KEY[2]~clkctrl_outclk\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \L10|EA~13_combout\ = (!\KEY~combout\(3) & ((\L10|EA.AGUARDA_SOLTAR_ENTER~regout\) # (!\L10|EA.INICIO~regout\)))
...
-- Equation(s):
-- \L10|EA~12_combout\ = (\L10|EA.AGUARDA_SOLTAR_ENTER~regout\ & \KEY~combout\(3))
...
-- Equation(s):
-- \L10|Selector1~1_combout\ = ((\L10|en_2~regout\ & ((\L10|WideOr8~0_combout\) # (\L10|EA~12_combout\)))) # (!\L10|Selector1~0_combout\)
...
PORT MAP (
	clk => \CLOCK_50~clkctrl_outclk\,
	datain => \L10|Selector1~1_combout\,
	ena => \KEY~combout\(2),
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \L4|m[1]~14_combout\ = (\SW~combout\(1) & (((!\L10|selecao\(0) & !\L0|Q\(1))) # (!\L10|selecao\(1)))) # (!\SW~combout\(1) & ((\L0|Q\(1)) # (\L10|selecao\(0) $ (!\L10|selecao\(1)))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "0011011011111101",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => \L10|selecao\(0),
...
-- Equation(s):
-- \LHEAUHEUHAE|F[1]~2_combout\ = (\L0|Q\(1) & ((\SW~combout\(1) & (\LHEAUHEUHAE|F[0]~1\ & VCC)) # (!\SW~combout\(1) & (!\LHEAUHEUHAE|F[0]~1\)))) # (!\L0|Q\(1) & ((\SW~combout\(1) & (!\LHEAUHEUHAE|F[0]~1\)) # (!\SW~combout\(1) & ((\LHEAUHEUHAE|F[0]~1\) # 
-- (GND)))))
-- \LHEAUHEUHAE|F[1]~3\ = CARRY((\L0|Q\(1) & (!\SW~combout\(1) & !\LHEAUHEUHAE|F[0]~1\)) # (!\L0|Q\(1) & ((!\LHEAUHEUHAE|F[0]~1\) # (!\SW~combout\(1)))))
...
-- Equation(s):
-- \L4|m[1]~15_combout\ = (\L4|m[1]~14_combout\ & ((\L10|selecao\(1)) # ((\L10|selecao\(0)) # (\LHEAUHEUHAE|F[1]~2_combout\))))
...
-- Equation(s):
-- \L4|m[2]~12_combout\ = (\SW~combout\(2) & (((!\L0|Q\(2) & !\L10|selecao\(0))) # (!\L10|selecao\(1)))) # (!\SW~combout\(2) & ((\L0|Q\(2)) # (\L10|selecao\(0) $ (!\L10|selecao\(1)))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "0011011011101111",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => \L0|Q\(2),
...
-- Equation(s):
-- \L4|m[2]~13_combout\ = (\L4|m[2]~12_combout\ & ((\L10|selecao\(1)) # ((\L10|selecao\(0)) # (\LHEAUHEUHAE|F[2]~4_combout\))))
...
-- Equation(s):
-- \LHEAUHEUHAE|F[3]~6_combout\ = (\SW~combout\(3) & ((\L0|Q\(3) & (\LHEAUHEUHAE|F[2]~5\ & VCC)) # (!\L0|Q\(3) & (!\LHEAUHEUHAE|F[2]~5\)))) # (!\SW~combout\(3) & ((\L0|Q\(3) & (!\LHEAUHEUHAE|F[2]~5\)) # (!\L0|Q\(3) & ((\LHEAUHEUHAE|F[2]~5\) # (GND)))))
-- \LHEAUHEUHAE|F[3]~7\ = CARRY((\SW~combout\(3) & (!\L0|Q\(3) & !\LHEAUHEUHAE|F[2]~5\)) # (!\SW~combout\(3) & ((!\LHEAUHEUHAE|F[2]~5\) # (!\L0|Q\(3)))))
...
-- Equation(s):
-- \L4|m[3]~10_combout\ = (\SW~combout\(3) & (((!\L10|selecao\(0) & !\L0|Q\(3))) # (!\L10|selecao\(1)))) # (!\SW~combout\(3) & ((\L0|Q\(3)) # (\L10|selecao\(0) $ (!\L10|selecao\(1)))))
...
-- Equation(s):
-- \L4|m[3]~11_combout\ = (\L4|m[3]~10_combout\ & ((\L10|selecao\(0)) # ((\L10|selecao\(1)) # (\LHEAUHEUHAE|F[3]~6_combout\))))
...
PORT MAP (
	dataa => \L10|selecao\(0),
	datab => \L10|selecao\(1),
	datac => \LHEAUHEUHAE|F[3]~6_combout\,
...
-- Equation(s):
-- \L4|m[4]~8_combout\ = (\SW~combout\(4) & (((!\L0|Q\(4) & !\L10|selecao\(0))) # (!\L10|selecao\(1)))) # (!\SW~combout\(4) & ((\L0|Q\(4)) # (\L10|selecao\(0) $ (!\L10|selecao\(1)))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "0101011011101111",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => \SW~combout\(4),
...
-- Equation(s):
-- \L4|m[4]~9_combout\ = (\L4|m[4]~8_combout\ & ((\L10|selecao\(0)) # ((\L10|selecao\(1)) # (\LHEAUHEUHAE|F[4]~8_combout\))))
...
\L4|m[5]~2\ : cycloneii_lcell_comb
-- Equation(s):
-- \L4|m[5]~2_combout\ = (\SW~combout\(5) & (((!\L10|selecao\(0) & !\L0|Q\(5))) # (!\L10|selecao\(1)))) # (!\SW~combout\(5) & ((\L0|Q\(5)) # (\L10|selecao\(0) $ (!\L10|selecao\(1)))))
...
\L4|m[5]~3\ : cycloneii_lcell_comb
-- Equation(s):
-- \L4|m[5]~3_combout\ = (\L10|selecao\(0) & (((\L4|m[5]~2_combout\)))) # (!\L10|selecao\(0) & ((\L10|selecao\(1) & (\L4|m[5]~2_combout\)) # (!\L10|selecao\(1) & ((\LHEAUHEUHAE|F[5]~10_combout\)))))
...
PORT MAP (
	dataa => \L10|selecao\(0),
	datab => \L10|selecao\(1),
	datac => \L4|m[5]~2_combout\,
	datad => \LHEAUHEUHAE|F[5]~10_combout\,
	combout => \L4|m[5]~3_combout\);
...
\L4|m[6]~4\ : cycloneii_lcell_comb
-- Equation(s):
-- \L4|m[6]~4_combout\ = (\SW~combout\(6) & (((!\L10|selecao\(0) & !\L0|Q\(6))) # (!\L10|selecao\(1)))) # (!\SW~combout\(6) & ((\L0|Q\(6)) # (\L10|selecao\(1) $ (!\L10|selecao\(0)))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "0111011101101011",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => \SW~combout\(6),
	...
	datac => \L10|selecao\(0),
	datad => \L0|Q\(6),
	combout => \L4|m[6]~4_combout\);

-- Location: LCCOMB_X62_Y3_N22
\LHEAUHEUHAE|F[6]~12\ : cycloneii_lcell_comb
-- Equation(s):
-- \LHEAUHEUHAE|F[6]~12_combout\ = ((\L0|Q\(6) $ (\SW~combout\(6) $ (!\LHEAUHEUHAE|F[5]~11\)))) # (GND)
-- \LHEAUHEUHAE|F[6]~13\ = CARRY((\L0|Q\(6) & ((\SW~combout\(6)) # (!\LHEAUHEUHAE|F[5]~11\))) # (!\L0|Q\(6) & (\SW~combout\(6) & !\LHEAUHEUHAE|F[5]~11\)))
...
\L4|m[6]~5\ : cycloneii_lcell_comb
-- Equation(s):
-- \L4|m[6]~5_combout\ = (\L10|selecao\(0) & (((\L4|m[6]~4_combout\)))) # (!\L10|selecao\(0) & ((\L10|selecao\(1) & (\L4|m[6]~4_combout\)) # (!\L10|selecao\(1) & ((\LHEAUHEUHAE|F[6]~12_combout\)))))
...
PORT MAP (
	dataa => \L10|selecao\(0),
	datab => \L10|selecao\(1),
	datac => \L4|m[6]~4_combout\,
	datad => \LHEAUHEUHAE|F[6]~12_combout\,
	combout => \L4|m[6]~5_combout\);
...
\L4|m[7]~6\ : cycloneii_lcell_comb
-- Equation(s):
-- \L4|m[7]~6_combout\ = (\SW~combout\(7) & (((!\L0|Q\(7) & !\L10|selecao\(0))) # (!\L10|selecao\(1)))) # (!\SW~combout\(7) & ((\L0|Q\(7)) # (\L10|selecao\(1) $ (!\L10|selecao\(0)))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "0111011001111011",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => \SW~combout\(7),
	...
	datac => \L0|Q\(7),
	datad => \L10|selecao\(0),
	combout => \L4|m[7]~6_combout\);

-- Location: LCCOMB_X62_Y3_N2
\L4|m[7]~7\ : cycloneii_lcell_comb
-- Equation(s):
-- \L4|m[7]~7_combout\ = (\L10|selecao\(0) & (((\L4|m[7]~6_combout\)))) # (!\L10|selecao\(0) & ((\L10|selecao\(1) & ((\L4|m[7]~6_combout\))) # (!\L10|selecao\(1) & (\LHEAUHEUHAE|F[7]~14_combout\))))
...
PORT MAP (
	dataa => \L10|selecao\(0),
	datab => \L10|selecao\(1),
	datac => \LHEAUHEUHAE|F[7]~14_combout\,
	datad => \L4|m[7]~6_combout\,
	combout => \L4|m[7]~7_combout\);
...
\L6|Q[0]~feeder\ : cycloneii_lcell_comb
-- Equation(s):
-- \L6|Q[0]~feeder_combout\ = \L4|m[0]~1_combout\
...
-- Equation(s):
-- \L9|F[5]~5_combout\ = (\L6|Q\(1) & (!\L6|Q\(3) & ((\L6|Q\(0)) # (!\L6|Q\(2))))) # (!\L6|Q\(1) & (\L6|Q\(0) & (\L6|Q\(2) $ (!\L6|Q\(3)))))
...
-- Equation(s):
-- \L8|F[2]~2_combout\ = (\L5|Q\(2) & (\L5|Q\(3) & ((\L5|Q\(1)) # (!\L5|Q\(0))))) # (!\L5|Q\(2) & (\L5|Q\(1) & (!\L5|Q\(0) & !\L5|Q\(3))))
...
-- Equation(s):
-- \L8|F[3]~3_combout\ = (\L5|Q\(1) & ((\L5|Q\(2) & (\L5|Q\(0))) # (!\L5|Q\(2) & (!\L5|Q\(0) & \L5|Q\(3))))) # (!\L5|Q\(1) & (!\L5|Q\(3) & (\L5|Q\(2) $ (\L5|Q\(0)))))
...
-- Equation(s):
-- \L8|F[5]~5_combout\ = (\L5|Q\(2) & (\L5|Q\(0) & (\L5|Q\(1) $ (\L5|Q\(3))))) # (!\L5|Q\(2) & (!\L5|Q\(3) & ((\L5|Q\(1)) # (\L5|Q\(0)))))

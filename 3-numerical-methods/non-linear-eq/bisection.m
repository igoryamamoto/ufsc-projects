function xc = bisection(fun,a,b,e1,e2,nMax)
%--------------------------------------------------------------------------
...
for k=1:nMax
    ...
    function plotGraphs()
        % Convergence Values
        figure('Name','Bisection:Convergence','NumberTitle','off','FileName','bisec_conv.eps');
        ...
        grid on;
        % Error Values
        figure('Name','Bisection:Relative Error','NumberTitle','off','FileName','bisec_err.eps');
